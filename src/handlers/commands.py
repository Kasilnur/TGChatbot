    ...
    def register_handlers(self):
        ...
        def start(message):
            ...
            welcome_text = (
                ...
                "Просто напиши мне что-нибудь или отправь голосовое сообщение! 🚀\n\n"
                "P.S DEV:\nДанная версия бота является тестовой, поэтому будьте аккуратны со своими данными, которые вы отправляете боту. Они обрабатываются на стороне нашего сервера"
            )
